...
<link type="text/css" rel="stylesheet" href="css/jieshao.css"/>
  ...
  <div>
   <h1><img src="img/dogintroduction/马尔济斯犬.jpg" align="left" width="23%" >
  <p> 马尔济斯犬<br></p>
     <h2><span>马尔济斯犬，是欧洲最古老的犬种，原产于地中海的英国属地-马尔他岛，而得此名。马尔济斯犬迄今已有近3000年的历史，
在古代便以其端庄高雅的姿态而深受贵妇们的娇宠。在目前犹存的地中海沿岸的工艺品和美术作品中，常可见到马尔济斯犬栩栩如生的艺术形象。
中世纪以前，一向是欧洲贵族门的日常伴侣，以后知名度也未曾减过。
	 </span></h2>
	  </h1>
  </div>
