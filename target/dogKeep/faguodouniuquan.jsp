...
<html>
  ...
  <body background="img/dogintroduction/背景图.jpg">
    ...
    <div>
      <h1>
        <img
          src="img/dogintroduction/法国斗牛犬.jpg"
          align="left"
          width="20%"
        />
        <p>法国斗牛犬<br /></p>
        <h2>
          <span
            >法国斗牛犬，表情显得警惕、好奇而感兴趣。除了切除狼爪以外，对他的任何改动都是错误的，属于失格。
            法国斗牛犬亲切，敦厚，忠诚，执著，勇敢，具有独特的品位，
            而且完全表露于表情与动作。亲切，憨厚，忠诚，执著，勇敢，具有独特的品位，而且完全表露于表情与动作。对小孩和善，同时也是作风彪悍，能力强的优秀护卫犬。</span
          >
        </h2>
      </h1>
    </div>
