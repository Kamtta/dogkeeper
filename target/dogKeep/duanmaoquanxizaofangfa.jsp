...
<html>
  ...
  <body background="img/dogintroduction/背景图.jpg">
    ...
    <h4>
      ...
      <p>nbsp&nbsp短毛犬洗澡方法：</p>
      <span>
        &nbsp&nbsp准备：毛巾、浴液等。所有准备工作应在梳洗前进行，保持常规的模式，这样你和宠物对整个过程才更有安全感。检查耳朵看是否需要清理，然后用脱脂棉堵住耳朵，以免进水。<br />
        &nbsp&nbsp洗澡：使用定量的，常规的全能浴液，使泡沫进入每个部分，冲洗后如需要应使用护发素，并再次冲洗。<br />
        &nbsp&nbsp吹干：尽量用毛巾擦干，让毛发在温暖的天气中自然晒干或使用吹风机吹干。把人类使用的吹风机调制为低档或中档，不要让吹风机只对着一个部位吹。<br /><br /><br />
      </span>
      <p>&nbsp&nbsp短毛犬洗澡视频讲解：</p>
      <iframe
        frameborder="0"
        height="300"
        width="400"
        src="https://v.qq.com/txp/iframe/player.html?vid=s08040gayay"
