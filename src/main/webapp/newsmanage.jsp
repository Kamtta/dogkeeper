...
<script>
            ...
            success:function (result) {
                ...
                $(result.content).each(function () {
                    str += "<tr>\n" +
                        ...
                        "                        <a class=\"dropdown-item\" href=\""+"updatenews.jsp?id="+this.id+"\" style='color: green'>修改</a>\n" +
                        "                        <a class=\"dropdown-item\" href=\""+"delete.news?id="+this.id+"\" style='color: green'>删除</a>\n" +
                        "                    </div>\n" +
                        "                </div>\n" +
                        "            </td>\n" +
                        "        </tr>"
    ...
    function doclick() {
        window.location.href = "newsadd.jsp";
    }
</script>
</body>
</html>
