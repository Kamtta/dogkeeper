...
<link type="text/css" rel="stylesheet" href="css/jieshao.css"/>
  ...
  <div>
   <h1><img src="img/dogintroduction/比格犬.jpg" align="left"width="20%"  >
  <p>比格犬<br></p>
     <h2><span>比格犬又称为米格鲁猎兔犬，是漫画史努比的原型犬只，是世界名犬犬种之一。在分类上属于狩猎犬，它的吠声比其他猎犬高亢，故有"森林之铃"之称。
	 活泼好动的比格犬在成为家庭犬之初并不太受欢迎，其原因为太过好动难以驯服，但在后来专业训狗人士与兽医的帮忙下逐渐适应人类的家庭生活，
	 最后成为家庭犬的一份子。</span></h2>
	  </h1>
  </div>
