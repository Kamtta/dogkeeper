...
<p style="margin-top: 100px;margin-left: 100px;width: 170px;height: 130px;font-size: 30px;text-align: center;" >
  <img src="img/dog/腹泻.jpg" align="left" style="border-radius: 50%;box-shadow: 2px 4px 4px;width: 170px;height: 130px;margin-bottom: 10px" />
  腹泻
</p><br><br><br>

<span>
<iframe height=400 width=800 src='https://player.youku.com/embed/XMTgyOTg2OTI5Ng==' frameborder=0 allowfullscreen style="margin-left: 200px"></iframe>
</span>
