...
<link type="text/css" rel="stylesheet" href="css/gougoujibingjiuzhi.css"/>
 ...
 <body background="img/dogintroduction/背景图.jpg">
  ...
  <h1><img src="img/dog/皮肤病.jpg"  width="23%">
  <p>皮肤病</p>
  <span>原因：外源性皮肤病多是由气候变化(温度、湿度)、体外寄生虫、病原体传染(真菌、疥螨等)、物理原因(外伤、剪毛、不合理注射)、化学原因(外用药、化学原料)等。<br>
&nbsp内源性皮肤病多是由狗狗自然衰老或机体抵抗力低下造成的。常见于夏秋两季:：疥螨感染、真菌感染、皮炎湿疹、体表蚊虫叮咬、溢脂性皮炎、蠕形螨等。<br>
<img src="img/dog/皮肤病1.jpg"  width="21%">
基本处理原则：<br>
...
(4)避免狗狗长时间在草地逗留<br>
<p>皮肤病视频讲解</p>
<iframe height=300 width=400 src='https://player.youku.com/embed/XNDAzNTI3MjI2OA==' frameborder=0 'allowfullscreen'></iframe>
</h1>
</span>
</body>
</html>